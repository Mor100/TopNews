...
public class YuleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        temp = SQLUtils.queryNewsByCategory("娱乐");
        ...
        NewsUtils.initData(temp,newsList,recyclerViewAdapter, UrlConnection.YULE_URL);
        ...
        rv.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        temp.clear();
                        NewsUtils.readUrl(UrlConnection.YULE_URL, new URLCallBack() {
                            @Override
