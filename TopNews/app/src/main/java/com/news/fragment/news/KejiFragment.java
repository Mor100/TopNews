...
public class KejiFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        temp = SQLUtils.queryNewsByCategory("科技");
        ...
        NewsUtils.initData(temp,newsList,recyclerViewAdapter, UrlConnection.KEJI_URL);
        ...
        rv.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        temp.clear();
                        NewsUtils.readUrl(UrlConnection.KEJI_URL, new URLCallBack() {
                            @Override
