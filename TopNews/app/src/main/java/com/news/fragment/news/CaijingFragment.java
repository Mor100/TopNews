...
public class CaijingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        temp = SQLUtils.queryNewsByCategory("财经");

        NewsUtils.initSettings(getActivity(),recyclerViewAdapter,rv);
        NewsUtils.initData(temp,newsList,recyclerViewAdapter,UrlConnection.CAIJING_URL);
        ...
        rv.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        temp.clear();
                        NewsUtils.readUrl(UrlConnection.CAIJING_URL, new URLCallBack() {
                            @Override
