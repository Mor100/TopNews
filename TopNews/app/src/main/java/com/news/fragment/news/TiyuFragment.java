...
public class TiyuFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        temp = SQLUtils.queryNewsByCategory("体育");
        ...
        NewsUtils.initData(temp,newsList,recyclerViewAdapter, UrlConnection.TIYU_URL);
        ...
        rv.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        temp.clear();
                        NewsUtils.readUrl(UrlConnection.TIYU_URL, new URLCallBack() {
                            @Override
