...
public class ShishangFragment extends Fragment {
    ...
    private View view;
    private LeftImageRecyclerViewAdapter recyclerViewAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        temp = SQLUtils.queryNewsByCategory("时尚");
        recyclerViewAdapter = new LeftImageRecyclerViewAdapter(newsList, getActivity());

        NewsUtils.initSettings(getActivity(),recyclerViewAdapter,rv);
        NewsUtils.initData(temp,newsList,recyclerViewAdapter, UrlConnection.SHISHANG_URL);
        ...
        rv.setOnPullLoadMoreListener(new PullLoadMoreRecyclerView.PullLoadMoreListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        temp.clear();
                        NewsUtils.readUrl(UrlConnection.SHISHANG_URL, new URLCallBack() {
                            @Override
