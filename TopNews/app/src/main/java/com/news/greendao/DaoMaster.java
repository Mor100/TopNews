...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        UserJoinNewsBeanDao.createTable(db, ifNotExists);
        UserJoinVideoDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        UserJoinNewsBeanDao.dropTable(db, ifExists);
        UserJoinVideoDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(UserJoinNewsBeanDao.class);
        registerDaoClass(UserJoinVideoDao.class);
